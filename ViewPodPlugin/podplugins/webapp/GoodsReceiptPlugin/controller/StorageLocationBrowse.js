sap.ui.define([
    ...
    let StorageLocationBrowseType = BrowseBase.extend("Kusuma.ext.viewplugins.GoodsReceiptPlugin.controller.StorageLocationBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "Kusuma.ext.viewplugins.GoodsReceiptPlugin.view.fragment.StorageLocationsBrowse",
