...
], function (PluginViewController, JSONModel, AjaxUtil, Fragment, Formatter, ErrorHandler, MessageToast, Column, Text, FormattedText, Button, Label, Input,DatePicker, Title, DateTimeUtils, Sorter, ColumnListItem, GRPostController) {
    "use strict";

 
    return PluginViewController.extend("Kusuma.ext.viewplugins.GRPlugin.controller.PluginView", {
        ...
        grSummaryData: function (sChannelId, sEventId, oData) {
        ...
        fetchGrMaterialData: function (sUrl, oParameters) {
            ...
            AjaxUtil.get(sUrl, oParameters, function (oResponseData) {
                ...
                for (let i = 0; i < that.itemtList.lineItems.length; i++) {
                    ...
                    let isBatchManaged = (that.itemtList.lineItems[i].batchManaged === undefined || that.itemtList.lineItems[i].batchManaged === "NONE") ? false : true;
