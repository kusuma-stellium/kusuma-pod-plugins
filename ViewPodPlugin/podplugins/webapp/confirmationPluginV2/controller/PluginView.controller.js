sap.ui.define(
  ...
  function (
    ...
    var oPluginViewController = PluginViewController.extend('Kusuma.ext.viewplugins.confirmationPluginV2.controller.PluginView', {
      metadata: {
        properties: {},
      },
        ...
        this.ajaxGetRequest(
          ...
          function (oResponseData) {
            ...
            if (!that.byId('ActivityDetailsDialog')) {
              Fragment.load({
                id: oView.getId(),
                name: 'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.ActivityDetails',
                controller: that,
      ...
      onPressReportButton: function (oEvent) {
        ...
        if (!this.byId('reportActivityDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.ReportActivity',
            controller: this,
          }).then(
            function (oDialog) {
              oDialog.setEscapeHandler(
      ...
      handleSortButtonPressed: function () {
        this.createViewSettingsDialog('Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.SortDialog').open();
      },
      ...
      onOpenReportQuantityDialog: async function (oEvent) {
        ...
        if (!this.byId('reportQuantityDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.ReportQuantity',
            controller: this,
          }).then(
            function (oDialog) {
              oDialog.setEscapeHandler(
      ...
      handleReasonCode: function () {
        ...
        if (this.selectReasonCodeDialog === undefined) {
          this.selectReasonCodeDialog = sap.ui.xmlfragment(
            ...
            'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.SelectReasonCodeDialog',
            this
          );
      ...
      onClickSave: function (oEvent) {
        ...
        if (this.selectReasonCodeDialog) {
          sap.ui.getCore().byId(sap.ui.core.Fragment.createId('selectReasonCodeDialog', 'searchBarReason')).setValue('');
        }
      ...
      loadReasonCodePopover: function () {
        if (!this.oReasonCodePopoverPromise) {
          let sFragment = 'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.ReasonCodePopover';
      ...
      handleReasonCodeUpdateFromPopover: function (event) {
        ...
        if (!this.updateReasonCodeDialog) {
          this.updateReasonCodeDialog = sap.ui.xmlfragment(
            ...
            'Kusuma.ext.viewplugins.confirmationPluginV2.view.fragments.UpdateReasonCodeDialog',
            this
          );
